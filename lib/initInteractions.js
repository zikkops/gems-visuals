...
export default function initInteractions() {
  ...
  var board = [
    { i: "NA", n: "Prof. Nehme Azoury", r: "Dean &amp; Deputy President, USEK &middot; Presiding", d: "Editor-in-Chief of the Arab Economic and Business Journal and General Secretary of the Arab Society of Business Faculties (BEPS)." },
    { i: "DJ", n: "Dr. Dima Jamali", r: "Dean, LAU School of Business", d: "A globally ranked authority on Corporate Social Responsibility, placed among the top 2% of sustainability scientists worldwide." },
    ...
    { i: "FB", n: "Dr. Frank Bournois", r: "Vice-President &amp; Dean, CEIBS", d: "Dean of the China Europe International Business School and former Dean of ESCP Business School &mdash; among France's foremost management scholars." },
    { i: "KA", n: "Dr. Karim Al Seghir", r: "Chancellor, Ajman University", d: "Economist and former Dean of the American University in Cairo's School of Business; advisory board member of Harvard Business Review Arabia." },
    ...
    { i: "TG", n: "Thami Ghorfi", r: "President, ESCA École de Management", d: "Founder of the pan-African business school in Casablanca; sits on Morocco's Higher Council for Education and the AACSB and GBSN advisory boards." },
    { i: "RM", n: "Dr. Rita El Meouchy", r: "Founder &amp; CEO, El Meouchy Education", d: "An education and leadership specialist with 25+ years' experience, creator of the &lsquo;EDU My Way&rsquo; platform and &lsquo;Shiny Career&rsquo; program." },
    ...
    { i: "FK", n: "Fadi El Khatib", r: "FIBA Hall of Fame &middot; &lsquo;The Lebanese Tiger&rsquo;", d: "Lebanon's all-time leading scorer across three FIBA World Championships, now Founder &amp; CEO of Champs Sports and Fitness Club, Dubai." },
    { i: "RF", n: "Rony Fahed", r: "Lebanese National-Team Basketball Star", d: "A veteran guard who represented Lebanon at three FIBA World Championships." },
    { i: "HA", n: "Gen. Haroun Abdel Kader", r: "Public Security Commissioner, Roubaix", d: "Founder &amp; President of &lsquo;Les Chemins de la Réussite,&rsquo; championing republican meritocracy and equal opportunity with EDHEC Business School." },
  ...
  if (bg) {
    ...
    board.forEach(function (p) {
      ...
      el.innerHTML = '<div class="portrait"><span class="mono">' + p.i + '</span></div><div class="pn">' + p.n + '</div><div class="pt">' + p.r + '</div><div class="pr" style="margin-top:10px">' + p.d + '</div>';
      bg.appendChild(el);
    });
  }
  ...
  if (vg) {
    ...
    voices.forEach(function (v) {
      ...
      el.innerHTML = '<div class="pt" style="color:var(--gold);font-size:10px;letter-spacing:.16em;text-transform:uppercase">' + v.o + '</div><h3 style="margin-top:8px;font-size:16px">' + v.n + '</h3><p>' + v.t + '</p>';
      vg.appendChild(el);
    });
  }
